...
bool bumperCallback(btManifoldPoint& cp, const btCollisionObjectWrapper* obj1, int id1, int index1, const btCollisionObjectWrapper* obj2, int id2, int index2)
  {
    ...
    if((temp1Ptr == level1Ptr || temp2Ptr == level1Ptr) && jumping == false)
    {
        canJump = true;
    }

    else if((temp1Ptr == level2Ptr || temp2Ptr == level2Ptr) && jumping == false)
    {
        canJump = true;
        //cout << "can jump again!" << endl;
    }

    else if((temp1Ptr == level3Ptr || temp2Ptr == level3Ptr) && jumping == false)
    {
        canJump = true;
        //cout << "can jump again!" << endl;
    }

    else if((temp1Ptr == level4Ptr || temp2Ptr == level4Ptr) && jumping == false)
    {
        canJump = true;
        //cout << "can jump again!" << endl;
    }

    else if((temp1Ptr == level5Ptr || temp2Ptr == level5Ptr) && jumping == false)
    {
        canJump = true;
        //cout << "can jump again!" << endl;
    }

    else if((temp1Ptr == level6Ptr || temp2Ptr == level6Ptr) && jumping == false)
    {
        canJump = true;
        //cout << "can jump again!" << endl;
    }
