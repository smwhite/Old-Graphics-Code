...
bool Graphics::Initialize(int width, int height)
{
  ...
  m_earth = new Object(glm::mat4(1.0f),20.0f, 5600, 460000, vertexFile, fragmentFile, "../models/earth.obj");
...
void Graphics::Update(unsigned int dt,bool rotation,bool translation, int pause,bool moonR,bool moonT, int moonP, float LR, float UD,float ELR, float EUD, float ZOOM)
{
  ...
  m_jupiter->Update(dt,rotation,translation,pause,glm::mat4(1.0f),0.3f);
  m_saturn->Update(dt,rotation,translation,pause,glm::mat4(1.0f),0.3f);
  ...
  m_pluto->Update(dt,rotation,translation,pause,glm::mat4(1.0f),2.0f);
